...
# Update site from base repository (ssr-base) script

# --- Configuration ---
BASE_REMOTE_NAME="ssr-base"
BASE_REMOTE_URL="git@github.com:andersmosshall/ssr.git"
BASE_BRANCH="main"
COMMIT_MESSAGE="Auto merged ssr-base"
...
# 1. Setup ssr-base remote if it doesn't exist
...
# 3. Fetch the latest main branch from ssr-base
...
# 4. Attempt to merge ssr-base/main into the current branch without committing
