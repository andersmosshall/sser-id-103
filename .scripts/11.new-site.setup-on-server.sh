...
echo "   (e.g., using 'mysqldump -u [DB_USER] -p [DB_NAME] > bkp-[date]-pre-cim.sql"
echo "   ================================================================"
echo ""
echo "------------------------------------------------------------"
...
echo "   Take an initial state DB dump (e.g., 'mysqldump -u [DB_USER] -p [DB_NAME] > bkp-[date]-init.sql')."
echo ""
echo "2. Add organizations (school organizer, school, school unit with school grades):"
echo "   Visit [YOUR_SITE_URL]/organizations to handle."
echo ""
echo "3. Sanity Check Page:"
echo "   Visit [YOUR_SITE_URL]/sanity-check and verify."
echo ""
echo "4. Subject Taxonomy:"
echo "   Check [YOUR_SITE_URL]/admin/structure/taxonomy/manage/school_subject/overview"
echo ""
echo "5. Grade System Taxonomy:"
