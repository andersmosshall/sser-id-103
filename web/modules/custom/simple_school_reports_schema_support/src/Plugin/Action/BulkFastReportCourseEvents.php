 ...
 *
 * @Action(
 *   id = "ssr_multiple_fast_report_course_event",
 *   label = @Translation("Fast report lessons"),
 *   type = "ssr_calendar_event",
 *   confirm_form_route_name = "simple_school_reports_schema.multiple_fast_report"
 * )
 */
class BulkFastReportCourseEvents extends ActionBase implements ContainerFactoryPluginInterface {
  ...
  public function executeMultiple(array $entities) {
    $this->tempStoreFactory->get('fast_report_multiple_course_events')->set($this->currentUser->id(), $entities);
  }
