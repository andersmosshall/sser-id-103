...
class ChildCareSchemaDeviationStudent extends ContentEntityBase implements ChildCareSchemaDeviationStudentInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type): array {
    ...
    $fields['created'] = BaseFieldDefinition::create('created')
      ...
      ->setDescription(t('The time that the child care schema deviation student was created.'))
      ->setDisplayOptions('view', [
        'label' => 'above',
        'type' => 'timestamp',
        'weight' => 20,
    ...
    $fields['changed'] = BaseFieldDefinition::create('changed')
      ->setLabel(t('Changed'))
      ->setDescription(t('The time that the child care schema deviation student was last edited.'));
