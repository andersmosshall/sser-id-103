...
class ChildCareSchemaDeviation extends ContentEntityBase implements ChildCareSchemaDeviationInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type): array {
    ...
    $fields['created'] = BaseFieldDefinition::create('created')
      ...
      ->setDescription(t('The time that the child care schema deviation was created.'))
      ->setDisplayOptions('view', [
        'label' => 'above',
        'type' => 'timestamp',
        'weight' => 20,
    ...
    $fields['changed'] = BaseFieldDefinition::create('changed')
      ->setLabel(t('Changed'))
      ->setDescription(t('The time that the child care schema deviation was last edited.'));
