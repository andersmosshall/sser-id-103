...
use Drupal\simple_school_reports_grade_support\Form\UnlockCourseGradeRegistrationFormBase;

/**
 * Provides a form base for grade registration.
 */
class UnlockCourseGradeRegistrationFormGy extends UnlockCourseGradeRegistrationFormBase {
