...
/**
 * Defines the access control handler for the gradesigning entity type.
 *
 * phpcs:disable Drupal.Arrays.Array.LongLineDeclaration
 *
 * @see https://www.drupal.org/project/coder/issues/3185082
 */
final class GradeSigningAccessControlHandler extends EntityAccessControlHandler {
  ...
  protected function checkCreateAccess(AccountInterface $account, array $context, $entity_bundle = NULL): AccessResult {
    return AccessResult::allowedIfHasPermissions($account, ['create ssr_grade_signing', 'administer ssr_grade_signing'], 'OR');
  }
