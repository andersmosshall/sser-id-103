...
/**
 * Field handler to summarize invalid absence for student
 *
 * @ingroup views_field_handlers
 *
 * @ViewsField("invalid_absence_student")
 */
class InvalidAbsenceStudent extends FieldPluginBase {
  ...
  public function query() {
    ...
    $this->query->addField(NULL, $cases, 'cia');
  }
