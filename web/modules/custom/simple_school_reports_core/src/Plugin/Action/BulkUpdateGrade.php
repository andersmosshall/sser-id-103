 ...
 *
 * @Action(
 *   id = "simple_school_reports_core_bulk_update_grade",
 *   label = @Translation("Bulk update grade"),
 *   type = "user",
 *   confirm_form_route_name = "simple_school_reports_core.bulk_update_grade"
 * )
 */
class BulkUpdateGrade extends ActionBase implements ContainerFactoryPluginInterface {
  ...
  public function executeMultiple(array $entities) {
    $this->tempStoreFactory->get('bulk_update_grade')->set($this->currentUser->id(), $entities);
  }
