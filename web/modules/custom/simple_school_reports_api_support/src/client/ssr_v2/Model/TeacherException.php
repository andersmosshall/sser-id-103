...
class TeacherException extends \ArrayObject
{
    /**
     * @var array
     */
    ...
    protected $endTime;
    /**
     * Undervisningstid i minuter för läraren. Om den ej anges så gäller det som är angivet i, i första hand, CalendarEvent, och annars i Activity.
     *
     * @var int
     */
