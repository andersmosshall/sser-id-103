...
class SpecialisationCourseContent extends \ArrayObject
{
    /**
     * @var array
     */
    ...
    /**
     * Titel på specialiseringskurs.
     *
     * @var string
     */
    protected $title;
    /**
     * Beskrivning av specialiseringskurs.
     *
     * @var string
     */
    protected $description;
    /**
     * Eventuell engelsk titel på specialiseringskurs.
     *
     * @var string
     */
    protected $titleEnglish;
    /**
     * Eventuell engelsk beskrivning av specialiseringskurs.
     *
     * @var string
     */
