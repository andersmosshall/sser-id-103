...
class StudentExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Drupal\simple_school_reports_api_support\client\ssr_v2\Model\StudentException::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Drupal\simple_school_reports_api_support\client\ssr_v2\Model\StudentException::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Drupal\simple_school_reports_api_support\client\ssr_v2\Model\StudentException();
        ...
        if (\array_key_exists('student', $data)) {
            $object->setStudent($this->denormalizer->denormalize($data['student'], \Drupal\simple_school_reports_api_support\client\ssr_v2\Model\PersonReference::class, 'json', $context));
            unset($data['student']);
        }
    ...
    {
        $dataArray = [];
        $dataArray['student'] = $this->normalizer->normalize($data->getStudent(), 'json', $context);
    ...
    {
        return [\Drupal\simple_school_reports_api_support\client\ssr_v2\Model\StudentException::class => false];
    }
}