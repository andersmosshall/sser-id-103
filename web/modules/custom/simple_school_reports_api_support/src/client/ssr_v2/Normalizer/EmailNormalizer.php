...
class EmailNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Drupal\simple_school_reports_api_support\client\ssr_v2\Model\Email::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Drupal\simple_school_reports_api_support\client\ssr_v2\Model\Email::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Drupal\simple_school_reports_api_support\client\ssr_v2\Model\Email();
    ...
    {
        return [\Drupal\simple_school_reports_api_support\client\ssr_v2\Model\Email::class => false];
    }
}