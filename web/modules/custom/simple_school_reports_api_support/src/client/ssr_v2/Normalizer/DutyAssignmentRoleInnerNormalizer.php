...
class DutyAssignmentRoleInnerNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Drupal\simple_school_reports_api_support\client\ssr_v2\Model\DutyAssignmentRoleInner::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Drupal\simple_school_reports_api_support\client\ssr_v2\Model\DutyAssignmentRoleInner::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Drupal\simple_school_reports_api_support\client\ssr_v2\Model\DutyAssignmentRoleInner();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('group', $data)) {
            $object->setGroup($this->denormalizer->denormalize($data['group'], \Drupal\simple_school_reports_api_support\client\ssr_v2\Model\GroupReference::class, 'json', $context));
            unset($data['group']);
        }
    ...
    {
        return [\Drupal\simple_school_reports_api_support\client\ssr_v2\Model\DutyAssignmentRoleInner::class => false];
    }
}