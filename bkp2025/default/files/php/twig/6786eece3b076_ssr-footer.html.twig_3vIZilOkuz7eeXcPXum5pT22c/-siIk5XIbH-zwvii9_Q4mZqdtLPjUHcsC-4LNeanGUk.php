...
/* themes/custom/ssr_base/components/footer/ssr-footer.html.twig */
class __TwigTemplate_1083e4aed9a097a65c47ecd055eee063 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 1
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->attachLibrary("ssr_base/footer"), "html", null, true);
        yield "
...
<div class=\"ssr-footer\">
  <div class=\"ssr-footer--inner\">
    ";
        // line 5
        if ((($context["bug_report_link"] ?? null) || ($context["help_link"] ?? null))) {
            // line 6
            yield "      <div class=\"ssr-help\">
        ";
            // line 7
            if (($context["bug_report_link"] ?? null)) {
                // line 8
                yield "          <div class=\"bug-report\">
            <a href=\"";
                // line 9
                yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ($context["bug_report_link"] ?? null), "html", null, true);
                yield "\">
              <div class=\"icon\">
                <svg version=\"1.1\" id=\"Layer_1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" x=\"0px\" y=\"0px\"
                     width=\"24px\" height=\"24px\" viewBox=\"0 0 24 24\" enable-background=\"new 0 0 24 24\" xml:space=\"preserve\">
                  <g id=\"Error\">
                    <path id=\"Mask\" d=\"M11.134,2.5c0.276-0.478,0.888-0.642,1.366-0.366c0.152,0.088,0.278,0.214,0.366,0.366l0,0L22.392,19
\t\tc0.276,0.479,0.112,1.09-0.366,1.366c-0.151,0.087-0.324,0.134-0.5,0.134l0,0H2.473c-0.552,0-1-0.447-1-1
\t\tc0-0.176,0.047-0.348,0.135-0.5l0,0L11.134,2.5z M12,14.742c-0.958,0-1.734,0.777-1.734,1.734s0.777,1.734,1.734,1.734
\t\tc0.959,0,1.734-0.777,1.734-1.734S12.959,14.742,12,14.742z M12,6.221c-0.033,0-0.065,0-0.097,0.002
\t\tc-1.003,0.045-1.772,0.77-1.719,1.616l0,0l0.301,4.731c0.042,0.679,0.708,1.213,1.515,1.213s1.473-0.534,1.517-1.213l0,0
\t\tc0,0,0.302-4.786,0.302-4.813C13.818,6.908,13.004,6.221,12,6.221z\"/>
                  </g>
</svg>
              </div>
              <div>
                ";
                // line 24
                yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(t("I have found an issue"));
                yield "
              </div>
            </a>
          </div>
        ";
            ...
            // line 29
            yield "        ";
            if (($context["help_link"] ?? null)) {
                // line 30
                yield "          <div class=\"help\">
            <a href=\"";
                // line 31
                yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ($context["help_link"] ?? null), "html", null, true);
                yield "\">
              <div class=\"icon\">
...
<title>Icon / 16px /  Information</title>
                  <desc>Created with Sketch.</desc>
                  <g id=\"Icon-_x2F_-16px-_x2F_--Information\">
                    <path id=\"Path\" d=\"M8,1C4.134,1,1,4.134,1,8c0,3.865,3.134,7,7,7s7-3.135,7-7C15,4.134,11.866,1,8,1z M8.777,5.891   C8.566,6.086,8.291,6.194,8.003,6.188C7.716,6.193,7.437,6.086,7.226,5.891C7.019,5.708,6.9,5.443,6.903,5.166   C6.9,4.888,7.019,4.624,7.226,4.44C7.443,4.239,7.701,4.14,8.003,4.14c0.3,0,0.561,0.1,0.774,0.301   c0.207,0.185,0.324,0.449,0.32,0.725C9.097,5.449,8.992,5.691,8.777,5.891L8.777,5.891z M9.01,10.904   c0,0.528-0.443,0.956-0.992,0.956l0,0c-0.549,0-0.992-0.428-0.992-0.956V7.71c0-0.528,0.443-0.957,0.992-0.957l0,0   c0.548,0,0.992,0.428,0.992,0.957V10.904z\"/>
                  </g>
</svg>
              </div>
              <div>
...
\t\tc0,0.419-0.157,0.765-0.471,1.037s-0.747,0.409-1.3,0.409C120.944,14.28,120.52,14.16,120.18,13.92z\"/>
      ...
      <div class=\"name\">Anders Mosshäll</div>
    </div>
  </div>
</div>
";
        $this->env->getExtension('\Drupal\Core\Template\TwigExtension')
            ->checkDeprecations($context, ["bug_report_link", "help_link"]);        yield from [];
    }
    ...
    {
        return "themes/custom/ssr_base/components/footer/ssr-footer.html.twig";
    }
    ...
    {
        return array (  120 => 50,  115 => 47,  107 => 42,  93 => 31,  90 => 30,  87 => 29,  79 => 24,  61 => 9,  58 => 8,  56 => 7,  53 => 6,  51 => 5,  44 => 1,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "themes/custom/ssr_base/components/footer/ssr-footer.html.twig", "/app/web/themes/custom/ssr_base/components/footer/ssr-footer.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = array("if" => 5);
        static $filters = array("escape" => 1, "t" => 24);
